...
var G__32337 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__32337;
continue;
} else {
var G__32338 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__32338;
continue;
}
} else {
var G__32339 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__32339;
continue;
}
}
...
var G__32317 = zloc;
var G__32318 = (function (){var G__32321 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__32322 = zloc;
var G__32322__$1 = (((G__32322 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__32322) : rewrite_clj.zip.node.call(null,G__32322)));
if((G__32322__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__32322__$1) : zprint.zutil.edn_STAR_.call(null,G__32322__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__32321) : rewrite_clj.zip.root.call(null,G__32321));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__32317,G__32318) : rewrite_clj.zip.replace.call(null,G__32317,G__32318));
});
/**
...
var G__32347 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__32347;
continue;
}
break;
...
var G__32348 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__32349 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__32348;
out = G__32349;
continue;
} else {
...
var G__32360 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__32361 = cljs.core.next(new_loc);
var G__32362 = replaced_loc;
nloc = G__32360;
new_loc = G__32361;
last_loc = G__32362;
continue;
...
return zprint.rewrite.sort_val((function (){var G__32331 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__32331) : rewrite_clj.zip.down.call(null,G__32331));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__32334_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__32334_SHARP_) : rewrite_clj.zip.tag.call(null,p1__32334_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__32334_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__32334_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
