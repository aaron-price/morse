...
var G__31863 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__31863__$1 = (((G__31863 == null))?null:cljs.core.iterate((function (loc){
...
var G__31863__$2 = (((G__31863__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__31863__$1));
var G__31863__$3 = (((G__31863__$2 == null))?null:cljs.core.last(G__31863__$2));
if((G__31863__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__31863__$3);
}
} else {
return zloc;
}
...
var G__31872 = rewrite_clj.zip.move.right(v);
var G__31873 = rewrite_clj.zip.move.up(v);
loc = G__31872;
parent = G__31873;
continue;
} else {
var G__31874 = rewrite_clj.zip.move.right(v0);
var G__31875 = parent;
loc = G__31874;
parent = G__31875;
continue;
...
var G__31876 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__31877 = rewrite_clj.zip.move.up(v);
loc = G__31876;
parent = G__31877;
continue;
} else {
var G__31878 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__31879 = parent;
loc = G__31878;
parent = G__31879;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__31870 = zloc;
var G__31870__$1 = (((G__31870 == null))?null:rewrite_clj.zip.move.down(G__31870));
var G__31870__$2 = (((G__31870__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__31870__$1,k));
if((G__31870__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__31870__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__31871 = rewrite_clj.zip.move.down(zloc);
var G__31871__$1 = (((G__31871 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__31871));
if((G__31871__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__31871__$1);
}
})(),k);
}
});
