...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27341 = c;
var G__27341__$1 = (((G__27341 == null))?null:G__27341.prototype);
if((G__27341__$1 == null)){
return null;
} else {
return G__27341__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27346 = c;
var G__27346__$1 = (((G__27346 == null))?null:G__27346.prototype);
if((G__27346__$1 == null)){
return null;
} else {
return G__27346__$1.render;
}
})() == null)))));
});
...
while (G__27446__i < G__27446__a.length) {G__27446__a[G__27446__i] = arguments[G__27446__i + 0]; ++G__27446__i;}
  args = new cljs.core.IndexedSeq(G__27446__a,0,null);
} 
...
var or__4126__auto__ = (function (){var G__27349 = c;
var G__27349__$1 = (((G__27349 == null))?null:G__27349.constructor);
if((G__27349__$1 == null)){
return null;
} else {
return G__27349__$1.displayName;
}
})();
...
var G__27350 = c;
var G__27350__$1 = (((G__27350 == null))?null:G__27350.constructor);
if((G__27350__$1 == null)){
return null;
} else {
return G__27350__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__27355 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27356 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27356);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27355);
}});
...
var c = this;
var G__27365_27459 = goog.object.get(c,"cljsRatom");
if((G__27365_27459 == null)){
} else {
reagent.ratom.dispose_BANG_(G__27365_27459);
}
...
var renders_27461 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_27462 = cljs.core.first(cljs.core.vals(renders_27461));
...
if((cljs.core.count(renders_27461) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_27461))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_27462)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_27462], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__27369 = o;
goog.object.set(G__27369,cljs.core.name(k),v);
...
G__27464.cljs$lang$applyTo = (function (arglist__27467){
...
var _STAR_current_component_STAR__orig_val__27384 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27385 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27385);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27384);
}});
...
var vec__27408 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27408,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27408,(1),null);
...
var G__27411 = goog.object.get(reagent_state,"cljsRatom");
if((G__27411 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__27411);
}
});
}),[]);
