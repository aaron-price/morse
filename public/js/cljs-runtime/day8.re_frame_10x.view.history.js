...
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"history-list",new cljs.core.Keyword(null,"height","height",1025178622),"20%",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var iter__4529__auto__ = (function day8$re_frame_10x$view$history$render_$_iter__33231(s__33232){
return (new cljs.core.LazySeq(null,(function (){
var s__33232__$1 = s__33232;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__33232__$1);
if(temp__5735__auto__){
var s__33232__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__33232__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__33232__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__33234 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__33233 = (0);
while(true){
if((i__33233 < size__4528__auto__)){
var vec__33241 = cljs.core._nth(c__4527__auto__,i__33233);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33241,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33241,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
cljs.core.chunk_append(b__33234,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__33267 = (i__33233 + (1));
i__33233 = G__33267;
continue;
} else {
var G__33268 = (i__33233 + (1));
i__33233 = G__33268;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__33234),day8$re_frame_10x$view$history$render_$_iter__33231(cljs.core.chunk_rest(s__33232__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__33234),null);
}
} else {
var vec__33246 = cljs.core.first(s__33232__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33246,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33246,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$history$render_$_iter__33231(cljs.core.rest(s__33232__$2)));
} else {
var G__33269 = cljs.core.rest(s__33232__$2);
s__33232__$1 = G__33269;
continue;
}
}
} else {
