...
app.core.routes = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["/",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword("app.core","index","app.core/index",-543884975),new cljs.core.Keyword(null,"view","view",1247994814),app.component.root.root], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["/learn/lesson1",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword("app.core","lesson1","app.core/lesson1",1041277185),new cljs.core.Keyword(null,"view","view",1247994814),app.component.page.learn.lesson1.page], null)], null)], null);
app.core.router = reitit.frontend.router.cljs$core$IFn$_invoke$arity$1(app.core.routes);
app.core.init = (function app$core$init(){
var path = window.location.pathname;
var route = reitit.frontend.match_by_path(app.core.router,path);
