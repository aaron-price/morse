...
var map__36346 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36346__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36346__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36346__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36346__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var map__36349 = spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$1(form);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36351__$1)].join('')));
...
var vec__36354 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36354,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36354,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36354,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36354,(3),null);
...
var vec__36357 = spec_tools.impl.extract_form(spec);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36357,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36357,(1),null);
...
var extra_info = (function (){var G__36360 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36360,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__36360;
}
})();
