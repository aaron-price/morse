...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__30865_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30865_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__30865_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__30868){
var vec__30869 = p__30868;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30869,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30869,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__30877,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30878__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30878__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30878__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__30886 = (function (){var or__4126__auto__ = color;
...
var fexpr__30885 = (function (){var G__30887 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__30887) : style_map.call(null,G__30887));
})();
return (fexpr__30885.cljs$core$IFn$_invoke$arity$1 ? fexpr__30885.cljs$core$IFn$_invoke$arity$1(G__30886) : fexpr__30885.call(null,G__30886));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__30888){
var vec__30889 = p__30888;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30889,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30889,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30889,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__30896){
var vec__30897 = p__30896;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30897,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30897,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30897,(2),null);
...
var G__31100 = cljs.core.next(ssv);
var G__31101 = (this_ssv == null);
var G__31102 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__31103 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__31100;
doing_nil_QMARK_ = G__31101;
last_elide = G__31102;
out = G__31103;
continue;
}
...
var vec__30907 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30907,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30907,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30907,(2),null);
...
var G__31104 = cljs.core.next(remaining_cvec);
var G__31105 = new_idx;
var G__31106 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__31104;
idx = G__31105;
out = G__31106;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__31000,cursor_vec){
var vec__31006 = p__31000;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31006,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31006,(1),null);
var focus_vec = vec__31006;
...
var vec__31016 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31016,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31016,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__31026){
var vec__31028 = p__31026;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31028,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31028,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__31046,existing_count){
var vec__31047 = p__31046;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31047,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31047,(1),null);
...
return cljs.core.filterv((function (p1__31043_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__31043_SHARP_))));
...
var vec__31069 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31069,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31069,(1),null);
var cvec_element = vec__31069;
if((cvec_element == null)){
var G__31141 = cljs.core.next(cvec_nl);
var G__31142 = (idx + (1));
var G__31143 = start;
var G__31144 = out;
cvec_nl = G__31141;
...
var G__31146 = cljs.core.next(cvec_nl);
var G__31147 = (idx + (1));
var G__31148 = idx;
var G__31149 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__31146;
idx = G__31147;
start = G__31148;
out = G__31149;
...
var G__31150 = cljs.core.next(cvec_nl);
var G__31151 = (idx + (1));
var G__31152 = (idx + (1));
var G__31153 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__31150;
idx = G__31151;
start = G__31152;
out = G__31153;
...
var G__31154 = cljs.core.next(cvec_nl);
var G__31155 = (idx + (1));
var G__31156 = idx;
var G__31157 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__31154;
idx = G__31155;
start = G__31156;
out = G__31157;
...
var G__31158 = cljs.core.next(cvec_nl);
var G__31159 = (idx + (1));
var G__31160 = start;
var G__31161 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__31158;
idx = G__31159;
start = G__31160;
out = G__31161;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__31074_SHARP_,p2__31073_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__31073_SHARP_)){
return cljs.core.reduced(p1__31074_SHARP_);
} else {
return (p1__31074_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__31075,p__31076){
var vec__31077 = p__31075;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31077,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31077,(1),null);
var vec__31080 = p__31076;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31080,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31080,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__31084,cvec,focus_vec){
...
var options = map__31085__$1;
var map__31086 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31085__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31086__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31086__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31086__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31083_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__31083_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
