...
var vec__33900 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__33903 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33903,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33903,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33900,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33900,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__33906){
var vec__33907 = p__33906;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33907,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33907,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33910,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33910,(1),null);
...
var vec__33921 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33921,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33921,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33921,(2),null);
var vec__33924 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33924,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33924,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33924,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__33935){
var vec__33936 = p__33935;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33936,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33936,(1),null);
...
var vec__33939 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33939,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33939,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33939,(2),null);
...
var vec__33945 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33945,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33945,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33945,(2),null);
var tuple = vec__33945;
...
var G__34055 = cljs.core.next(style_vec);
var G__34056 = ends_w_blanks_QMARK_;
var G__34057 = tuple;
var G__34058 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__34055;
previous_ends_w_blanks_QMARK_ = G__34056;
previous_tuple = G__34057;
out = G__34058;
continue;
}
break;
...
var vec__33951 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33951,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33951,(1),null);
...
var result = (function (){var G__33954 = zprint.core.parse_string_all_options(rest_options);
var G__33955 = zprint.core.zprint_str_internal;
var G__33956 = ":parse-string-all? call";
var G__33957 = (function (){var G__33958 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__33958) : zprint.zutil.edn_STAR_.call(null,G__33958));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__33954,G__33955,G__33956,G__33957) : zprint.core.process_multiple_forms.call(null,G__33954,G__33955,G__33956,G__33957));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__33964 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33964,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33964,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq33948){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33949,G__33950,seq33948__$2);
}));
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq33970){
var G__33971 = cljs.core.first(seq33970);
var seq33970__$1 = cljs.core.next(seq33970);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33971,seq33970__$1);
}));
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq33972){
var G__33973 = cljs.core.first(seq33972);
var seq33972__$1 = cljs.core.next(seq33972);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33973,seq33972__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___34090 = arguments.length;
var i__4737__auto___34091 = (0);
while(true){
if((i__4737__auto___34091 < len__4736__auto___34090)){
args__4742__auto__.push((arguments[i__4737__auto___34091]));

var G__34092 = (i__4737__auto___34091 + (1));
i__4737__auto___34091 = G__34092;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq33974){
var G__33975 = cljs.core.first(seq33974);
var seq33974__$1 = cljs.core.next(seq33974);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33975,seq33974__$1);
}));
...
while(true){
if((i__4737__auto___34108 < len__4736__auto___34095)){
args__4742__auto__.push((arguments[i__4737__auto___34108]));

var G__34110 = (i__4737__auto___34108 + (1));
i__4737__auto___34108 = G__34110;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq33976){
var G__33977 = cljs.core.first(seq33976);
var seq33976__$1 = cljs.core.next(seq33976);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33977,seq33976__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__33979,form){
var vec__33980 = p__33979;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33980,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33980,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33980,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33980,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__33983 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33983,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33983,(1),null);
...
var G__34138 = cljs.core.next(sos);
var G__34139 = comment_QMARK_;
var G__34140 = (function (){var or__4126__auto__ = (!(empty_string_QMARK_));
if(or__4126__auto__){
return or__4126__auto__;
} else {
...
var G__34141 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__34138;
previous_comment_QMARK_ = G__34139;
start_interpolating_QMARK_ = G__34140;
out = G__34141;
continue;
}
break;
...
try{var vec__33988 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33988,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33988,(1),null);
...
var vec__33991 = (cljs.core.truth_((function (){var or__4126__auto__ = range_start__$1;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33991,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33991,(1),null);
...
var vec__33994 = (cljs.core.truth_((function (){var and__4115__auto__ = actual_start;
if(cljs.core.truth_(and__4115__auto__)){
return actual_end;
} else {
return and__4115__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33994,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33994,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33994,(2),null);
...
var forms = (function (){var G__33997 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__33997) : zprint.zutil.edn_STAR_.call(null,G__33997));
})();
