...
var vec__33216 = cljs.core.rest(expr);
...
var vec__33219 = first__33218;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33219,(0),null);
var form = seq__33217__$1;
...
var G__33222 = x;
var G__33222__$1 = (((G__33222 == null))?null:spec_tools.impl.polish(G__33222));
var G__33222__$2 = (((G__33222__$1 == null))?null:cljs.core.name(G__33222__$1));
if((G__33222__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__33222__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__33223 = x;
var G__33223__$1 = (((G__33223 == null))?null:cljs.core.name(G__33223));
if((G__33223__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__33223__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__33225){
...
var data = map__33226__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33226__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33226__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33226__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33226__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__33229){
...
var data = map__33230__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33230__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33230__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__33235 = data;
var G__33235__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33235,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__33235);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33235__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__33235__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__33240 = form;
var G__33240__$1 = (((G__33240 == null))?null:cljs.core.rest(G__33240));
if((G__33240__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__33240__$1);
}
})();
var G__33241 = m;
var G__33241__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33241,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__33237_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__33237_SHARP_)));
})):G__33241);
var G__33241__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33241__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__33238_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__33238_SHARP_)));
})):G__33241__$1);
var G__33241__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33241__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__33239_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__33239_SHARP_));
})):G__33241__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__33241__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__33242 = (function (){var G__33243 = form;
var G__33243__$1 = (((G__33243 == null))?null:cljs.core.rest(G__33243));
if((G__33243__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__33243__$1);
}
})();
var map__33242__$1 = (((((!((map__33242 == null))))?(((((map__33242.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33242.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__33242):map__33242);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33242__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33242__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33242__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33242__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__33247 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__33247) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__33248 = form;
var G__33248__$1 = (((G__33248 == null))?null:cljs.core.seq(G__33248));
var G__33248__$2 = (((G__33248__$1 == null))?null:cljs.core.first(G__33248__$1));
if((G__33248__$2 == null)){
return null;
} else {
var fexpr__33249 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__33249.cljs$core$IFn$_invoke$arity$1 ? fexpr__33249.cljs$core$IFn$_invoke$arity$1(G__33248__$2) : fexpr__33249.call(null,G__33248__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq33250){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq33250));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__33251){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__33260){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33261__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33261__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33261__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33261__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__33258_SHARP_){
return cljs.core.map_QMARK_(p1__33258_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__33259_SHARP_){
return cljs.core.contains_QMARK_(p1__33259_SHARP_,x);
});
}),req_keys));
