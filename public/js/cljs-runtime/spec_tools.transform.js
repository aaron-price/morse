...
if((x instanceof cljs.core.Keyword)){
var G__33438 = spec;
var G__33439 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__33438,G__33439) : f.call(null,G__33438,G__33439));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__33440 = spec;
var G__33441 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__33440,G__33441) : f.call(null,G__33440,G__33441));
} else {
return x;
...
if(typeof x === 'number'){
var G__33450 = spec;
var G__33451 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__33450,G__33451) : f.call(null,G__33450,G__33451));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e33463){if((e33463 instanceof Error)){
var ___$1 = e33463;
return x;
} else {
throw e33463;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__33488,x){
var map__33489 = p__33488;
var map__33489__$1 = (((((!((map__33489 == null))))?(((((map__33489.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33489.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__33489):map__33489);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33489__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__33491,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33492__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__33496,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33497__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
