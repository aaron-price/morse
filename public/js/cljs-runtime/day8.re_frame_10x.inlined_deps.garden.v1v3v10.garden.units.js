 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__28646,right){
...
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28647__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28647__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__28654 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28654,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28654,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28654,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28662__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__28663 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28663__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__28748__delegate = function (x,y,more){
...
var G__28749__i = 0, G__28749__a = new Array(arguments.length -  2);
while (G__28749__i < G__28749__a.length) {G__28749__a[G__28749__i] = arguments[G__28749__i + 2]; ++G__28749__i;}
  more = new cljs.core.IndexedSeq(G__28749__a,0,null);
} 
...
var x = cljs.core.first(arglist__28750);
arglist__28750 = cljs.core.next(arglist__28750);
var y = cljs.core.first(arglist__28750);
var more = cljs.core.rest(arglist__28750);
...
var G__28751 = null;
if (arguments.length > 2) {
var G__28752__i = 0, G__28752__a = new Array(arguments.length -  2);
while (G__28752__i < G__28752__a.length) {G__28752__a[G__28752__i] = arguments[G__28752__i + 2]; ++G__28752__i;}
G__28751 = new cljs.core.IndexedSeq(G__28752__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__28751);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28669__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__28670 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28670__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__28755__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__28760__i = 0, G__28760__a = new Array(arguments.length -  2);
while (G__28760__i < G__28760__a.length) {G__28760__a[G__28760__i] = arguments[G__28760__i + 2]; ++G__28760__i;}
  more = new cljs.core.IndexedSeq(G__28760__a,0,null);
} 
return G__28755__delegate.call(this,x,y,more);};
G__28755.cljs$lang$maxFixedArity = 2;
G__28755.cljs$lang$applyTo = (function (arglist__28761){
var x = cljs.core.first(arglist__28761);
arglist__28761 = cljs.core.next(arglist__28761);
var y = cljs.core.first(arglist__28761);
var more = cljs.core.rest(arglist__28761);
...
var G__28762 = null;
if (arguments.length > 2) {
var G__28763__i = 0, G__28763__a = new Array(arguments.length -  2);
while (G__28763__i < G__28763__a.length) {G__28763__a[G__28763__i] = arguments[G__28763__i + 2]; ++G__28763__i;}
G__28762 = new cljs.core.IndexedSeq(G__28763__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__28762);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28680__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__28681 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28681__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__28764__delegate = function (x,y,more){
...
while (G__28765__i < G__28765__a.length) {G__28765__a[G__28765__i] = arguments[G__28765__i + 2]; ++G__28765__i;}
  more = new cljs.core.IndexedSeq(G__28765__a,0,null);
} 
return G__28764__delegate.call(this,x,y,more);};
...
return G__28764__delegate(x,y,more);
});
...
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__28767);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__28691 = u(x);
var map__28691__$1 = (((((!((map__28691 == null))))?(((((map__28691.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28691.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28691):map__28691);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28691__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__28692 = u(y);
var map__28692__$1 = (((((!((map__28692 == null))))?(((((map__28692.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28692.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28692):map__28692);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28692__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__28772__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__28773__i = 0, G__28773__a = new Array(arguments.length -  2);
while (G__28773__i < G__28773__a.length) {G__28773__a[G__28773__i] = arguments[G__28773__i + 2]; ++G__28773__i;}
  more = new cljs.core.IndexedSeq(G__28773__a,0,null);
} 
return G__28772__delegate.call(this,x,y,more);};
G__28772.cljs$lang$maxFixedArity = 2;
G__28772.cljs$lang$applyTo = (function (arglist__28774){
var x = cljs.core.first(arglist__28774);
arglist__28774 = cljs.core.next(arglist__28774);
var y = cljs.core.first(arglist__28774);
var more = cljs.core.rest(arglist__28774);
...
var G__28775 = null;
if (arguments.length > 2) {
var G__28776__i = 0, G__28776__a = new Array(arguments.length -  2);
while (G__28776__i < G__28776__a.length) {G__28776__a[G__28776__i] = arguments[G__28776__i + 2]; ++G__28776__i;}
G__28775 = new cljs.core.IndexedSeq(G__28776__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__28775);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
