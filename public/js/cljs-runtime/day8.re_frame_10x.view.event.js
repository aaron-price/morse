...
var G__34067 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,i_s);
var G__34068 = (i_s + (1));
var G__34069 = (i_s_SINGLEQUOTE_ + (1));
v = G__34067;
i_s = G__34068;
i_s_SINGLEQUOTE_ = G__34069;
continue;
} else {
var G__34070 = v;
var G__34071 = (i_s + (1));
var G__34072 = i_s_SINGLEQUOTE_;
v = G__34070;
i_s = G__34071;
i_s_SINGLEQUOTE_ = G__34072;
continue;
...
var vec__34012 = day8.re_frame_10x.view.event.collapse_whitespace_and_index(form_str);
var form_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34012,(0),null);
var reindex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34012,(1),null);
...
var vec__34015 = result;
var vec__34018 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34015,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34018,(0),null);
var pre_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34018,(1),null);
var matched_form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34018,(2),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34015,(1),null);
...
var start = (function (){var G__34021 = form_str__$1;
var G__34021__$1 = (((G__34021 == null))?null:clojure.string.index_of.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([search_str], 0)),G__34021));
if((G__34021__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__34021__$1);
}
})();
...
var end = (function (){var G__34022 = start;
var G__34022__$1 = (((G__34022 == null))?null:(length + G__34022));
if((G__34022__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__34022__$1);
}
})();
...
return day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.core.create_class.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function day8$re_frame_10x$view$event$event_expression_$_event_expression_component_will_update(this$){
...
var vec__34027 = day8.re_frame_10x.view.event.find_bounds(form_str,new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(highlighted_form),new cljs.core.Keyword(null,"num-seen","num-seen",-1576518431).cljs$core$IFn$_invoke$arity$1(highlighted_form));
var start_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34027,(0),null);
var end_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34027,(1),null);
...
return null;
});})(i__34045,id,first_QMARK_,frag,c__4527__auto__,size__4528__auto__,b__34046,s__34044__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments))
,new cljs.core.Keyword(null,"on-mouse-leave","on-mouse-leave",-1864319528),((function (i__34045,id,first_QMARK_,frag,c__4527__auto__,size__4528__auto__,b__34046,s__34044__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34046),day8$re_frame_10x$view$event$event_fragments_$_iter__34043(cljs.core.chunk_rest(s__34044__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34046),null);
}
} else {
var frag = cljs.core.first(s__34044__$2);
return cljs.core.cons((function (){var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(frag);
var first_QMARK_ = (id === (0));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"code-fragment",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-top","margin-top",392161226),((first_QMARK_)?null:"-1px")], null),new cljs.core.Keyword(null,"attr","attr",-604132353),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-mouse-enter","on-mouse-enter",-1664921661),((function (id,first_QMARK_,frag,s__34044__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","hover-form","code/hover-form",1557522458),frag], null));

return null;
});})(id,first_QMARK_,frag,s__34044__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments))
,new cljs.core.Keyword(null,"on-mouse-leave","on-mouse-leave",-1864319528),((function (id,first_QMARK_,frag,s__34044__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","exit-hover-form","code/exit-hover-form",-202062797),frag], null));
...
})(),day8$re_frame_10x$view$event$event_fragments_$_iter__34043(cljs.core.rest(s__34044__$2)));
}
} else {
return null;
}
