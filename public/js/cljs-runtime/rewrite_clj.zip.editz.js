...
var G__31800 = (function (){var G__31801 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__31801) : f.call(null,G__31801));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__31800) : rewrite_clj.node.coerce.call(null,G__31800));
});
/**
...
var G__31842 = (i__4737__auto___31841 + (1));
i__4737__auto___31841 = G__31842;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__31802_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__31802_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq31803){
var G__31805 = cljs.core.first(seq31803);
var seq31803__$1 = cljs.core.next(seq31803);
var G__31806 = cljs.core.first(seq31803__$1);
var seq31803__$2 = cljs.core.next(seq31803__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31805,G__31806,seq31803__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__31815 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__31815) : str_fn.call(null,G__31815));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__31816 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__31816) : str_fn.call(null,G__31816));
})()):null)));
...
var G__31826 = rewrite_clj.zip.base.tag(zloc);
var G__31826__$1 = (((G__31826 instanceof cljs.core.Keyword))?G__31826.fqn:null);
switch (G__31826__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__31821_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__31821_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__31825_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__31825_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31826__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__31834 = rewrite_clj.zip.base.tag(zloc);
var G__31834__$1 = (((G__31834 instanceof cljs.core.Keyword))?G__31834.fqn:null);
switch (G__31834__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__31833_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__31833_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
