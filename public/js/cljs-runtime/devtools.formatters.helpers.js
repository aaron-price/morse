...
var G__26781 = devtools.prefs.pref(v);
v = G__26781;
continue;
} else {
return v;
...
}catch (e26726){var _e__25911__auto__ = e26726;
return false;
}})();
...
}catch (e26732){var _e__25911__auto__ = e26732;
return false;
}})();
...
}catch (e26734){var _e__25911__auto__ = e26734;
return false;
}}
}
});
...
var vec__26756 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26756,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26756,(1),null);
...
return cljs.core.some((function (p1__26759_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__26759_SHARP_);
}),template);
});
