...
var fexpr__33266 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__33266.cljs$core$IFn$_invoke$arity$1 ? fexpr__33266.cljs$core$IFn$_invoke$arity$1(type) : fexpr__33266.call(null,type));
});
...
var G__33273 = spec_tools.impl.normalize_symbol(x);
var G__33274 = null;
var G__33275 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__33273,G__33274,G__33275) : spec_tools.parse.parse_form.call(null,G__33273,G__33274,G__33275));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__33277 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__33278 = x;
var G__33279 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__33277,G__33278,G__33279) : spec_tools.parse.parse_form.call(null,G__33277,G__33278,G__33279));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__33436 = cljs.spec.alpha.form(x);
var G__33437 = options;
x = G__33436;
options = G__33437;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__33280 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__33281 = null;
var G__33282 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__33280,G__33281,G__33282) : spec_tools.parse.parse_form.call(null,G__33280,G__33281,G__33282));
} else {
...
var G__33283 = parse_data;
var G__33283__$1 = (((G__33283 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__33283));
var G__33283__$2 = (((G__33283__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__33283__$1));
var G__33283__$3 = (((G__33283__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__33283__$2));
var G__33283__$4 = (((G__33283__$3 == null))?null:cljs.core.seq(G__33283__$3));
if((G__33283__$4 == null)){
return null;
} else {
return cljs.core.set(G__33283__$4);
}
}
});
...
var map__33333 = spec_tools.impl.parse_keys(form);
var map__33333__$1 = (((((!((map__33333 == null))))?(((((map__33333.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33333.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__33333):map__33333);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33333__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33333__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33333__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33333__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33333__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__33348 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__33348__$1 = (cljs.core.truth_((function (){var or__4126__auto__ = req;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33348,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__33348);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33348__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__33348__$1;
}
}));
...
var vec__33349 = multi_spec_form;
...
var multi_method_symbol = first__33351__$1;
var ___$1 = seq__33350__$2;
var form = vec__33349;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__33352){
var vec__33353 = p__33352;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33353,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33353,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__33356_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__33356_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__33357_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__33357_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__33370_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__33370_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33371_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__33371_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__33372 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33372__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__33391 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33391__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__33395,options){
var vec__33396 = p__33395;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33396,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33396,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33396,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__33400,options){
...
var ___$1 = first__33403;
var values = seq__33402__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__33399_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__33399_SHARP_,options);
}),values);
...
var type_priority = (function (p1__33425_SHARP_){
var G__33432 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__33431 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__33425_SHARP_);
return (fexpr__33431.cljs$core$IFn$_invoke$arity$1 ? fexpr__33431.cljs$core$IFn$_invoke$arity$1(G__33432) : fexpr__33431.call(null,G__33432));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33426_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__33426_SHARP_,options);
}),cljs.core.rest(form))));
}));
