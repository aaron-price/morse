...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k31374,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k31374,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__31396){
var vec__31397 = p__31396;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31397,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31397,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__31373){
var self__ = this;
var G__31373__$1 = this;
return (new cljs.core.RecordIter((0),G__31373__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this31375,other31376){
var self__ = this;
var this31375__$1 = this;
return (((!((other31376 == null)))) && ((this31375__$1.constructor === other31376.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31375__$1.tag,other31376.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31375__$1.wrap_fn,other31376.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31375__$1.wrap_length,other31376.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31375__$1.seq_fn,other31376.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31375__$1.children,other31376.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31375__$1.__extmap,other31376.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__31425 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__31425) : self__.seq_fn.call(null,G__31425));
}));
...
var self__ = this;
var this$__$1 = this;
var G__31427 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__31427) : self__.wrap_fn.call(null,G__31427));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__31373){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__31432 = cljs.core.keyword_identical_QMARK_;
var expr__31433 = k__4388__auto__;
if(cljs.core.truth_((pred__31432.cljs$core$IFn$_invoke$arity$2 ? pred__31432.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__31433) : pred__31432.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__31433)))){
return (new rewrite_clj.node.seq.SeqNode(G__31373,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31432.cljs$core$IFn$_invoke$arity$2 ? pred__31432.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__31433) : pred__31432.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__31433)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__31373,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31432.cljs$core$IFn$_invoke$arity$2 ? pred__31432.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__31433) : pred__31432.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__31433)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__31373,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31432.cljs$core$IFn$_invoke$arity$2 ? pred__31432.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__31433) : pred__31432.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__31433)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__31373,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31432.cljs$core$IFn$_invoke$arity$2 ? pred__31432.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__31433) : pred__31432.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__31433)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__31373,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__31373),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__31373){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__31373,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__31377){
var extmap__4419__auto__ = (function (){var G__31443 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__31377,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__31377)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__31443);
} else {
return G__31443;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__31377),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__31377),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__31377),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__31377),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__31377),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__31444_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__31444_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__31450_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__31450_SHARP_);
}),children);
});
