...
app.db.sym_chart = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54814){
var vec__54816 = p__54814;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54816,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54816,(1),null);
try{if((k === " ")){
...
}catch (e54822){if((e54822 instanceof Error)){
var e__34948__auto__ = e54822;
...
app.db.default_db = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"log","log",-1595516004),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"unit","unit",375175175),(200),new cljs.core.Keyword(null,"score","score",-1963588780),(0),new cljs.core.Keyword(null,"challenge","challenge",1302148691),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"text","text",-1790561697),"",new cljs.core.Keyword(null,"curr-code","curr-code",905590378),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"state","state",-1988618099),new cljs.core.Keyword(null,"waiting","waiting",895906735),new cljs.core.Keyword(null,"index","index",-1531685915),(0)], null),new cljs.core.Keyword(null,"input-text","input-text",-1336297114),"",new cljs.core.Keyword(null,"ticker","ticker",214613162),app.db.ticker], null);
