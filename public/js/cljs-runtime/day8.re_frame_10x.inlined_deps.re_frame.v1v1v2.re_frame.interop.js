...
return [(function (){var pred__29620 = cljs.core.instance_QMARK_;
var expr__29621 = reactive_val;
if(cljs.core.truth_((pred__29620.cljs$core$IFn$_invoke$arity$2 ? pred__29620.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__29621) : pred__29620.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__29621)))){
return "ra";
} else {
if(cljs.core.truth_((pred__29620.cljs$core$IFn$_invoke$arity$2 ? pred__29620.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__29621) : pred__29620.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__29621)))){
return "rc";
} else {
if(cljs.core.truth_((pred__29620.cljs$core$IFn$_invoke$arity$2 ? pred__29620.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__29621) : pred__29620.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__29621)))){
return "rx";
} else {
if(cljs.core.truth_((pred__29620.cljs$core$IFn$_invoke$arity$2 ? pred__29620.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__29621) : pred__29620.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__29621)))){
return "tr";
} else {
return "other";
}
