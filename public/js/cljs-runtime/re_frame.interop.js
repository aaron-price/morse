...
return [(function (){var pred__27232 = cljs.core.instance_QMARK_;
var expr__27233 = reactive_val;
if(cljs.core.truth_((pred__27232.cljs$core$IFn$_invoke$arity$2 ? pred__27232.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__27233) : pred__27232.call(null,reagent.ratom.RAtom,expr__27233)))){
return "ra";
} else {
if(cljs.core.truth_((pred__27232.cljs$core$IFn$_invoke$arity$2 ? pred__27232.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__27233) : pred__27232.call(null,reagent.ratom.RCursor,expr__27233)))){
return "rc";
} else {
if(cljs.core.truth_((pred__27232.cljs$core$IFn$_invoke$arity$2 ? pred__27232.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__27233) : pred__27232.call(null,reagent.ratom.Reaction,expr__27233)))){
return "rx";
} else {
if(cljs.core.truth_((pred__27232.cljs$core$IFn$_invoke$arity$2 ? pred__27232.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__27233) : pred__27232.call(null,reagent.ratom.Track,expr__27233)))){
return "tr";
} else {
return "other";
}
