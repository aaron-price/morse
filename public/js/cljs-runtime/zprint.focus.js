...
var G__30873 = (function (){var and__4115__auto__ = (function (){var or__4126__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index_type,new cljs.core.Keyword(null,"left","left",-399115937));
if(or__4126__auto__){
...
var G__30874 = new_next_nonws_QMARK_;
index = G__30872;
skip_to_right_QMARK_ = G__30873;
next_nonws_QMARK_ = G__30874;
continue;
}
}
break;
...
var G__30875 = zprint.focus.next_ssv(ssv,index);
var G__30876 = (moves - (1));
index = G__30875;
moves = G__30876;
continue;
}
...
var G__30880 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__30881 = cljs.core.next(nwp);
idx = G__30880;
nwp = G__30881;
continue;
}
