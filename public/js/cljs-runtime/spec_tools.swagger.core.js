...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__36363 = cljs.core.get_global_hierarchy;
return (fexpr__36363.cljs$core$IFn$_invoke$arity$0 ? fexpr__36363.cljs$core$IFn$_invoke$arity$0() : fexpr__36363.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__36420){
var map__36423 = p__36420;
var map__36423__$1 = (((((!((map__36423 == null))))?(((((map__36423.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__36423.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__36423):map__36423);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36423__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36423__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__36434 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36434,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36434,(1),null);
...
var method_cache__4621__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__36455 = cljs.core.get_global_hierarchy;
return (fexpr__36455.cljs$core$IFn$_invoke$arity$0 ? fexpr__36455.cljs$core$IFn$_invoke$arity$0() : fexpr__36455.call(null));
})());
...
var map__36459 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36459__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36459__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__36464){
var vec__36465 = p__36464;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36465,(0),null);
var map__36468 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36465,(1),null);
...
var schema = map__36468__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36468__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4621__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__36470 = cljs.core.get_global_hierarchy;
return (fexpr__36470.cljs$core$IFn$_invoke$arity$0 ? fexpr__36470.cljs$core$IFn$_invoke$arity$0() : fexpr__36470.call(null));
})());
...
})(),(function (){var iter__4529__auto__ = (function spec_tools$swagger$core$iter__36472(s__36473){
return (new cljs.core.LazySeq(null,(function (){
var s__36473__$1 = s__36473;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__36473__$1);
if(temp__5735__auto__){
var s__36473__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__36473__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__36473__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__36475 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__36474 = (0);
while(true){
if((i__36474 < size__4528__auto__)){
var vec__36476 = cljs.core._nth(c__4527__auto__,i__36474);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36476,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36476,(1),null);
cljs.core.chunk_append(b__36475,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__36475),spec_tools$swagger$core$iter__36472(cljs.core.chunk_rest(s__36473__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__36475),null);
}
} else {
var vec__36479 = cljs.core.first(s__36473__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36479,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36479,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__36472(cljs.core.rest(s__36473__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__36489){
var vec__36490 = p__36489;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36490,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36490,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__36494,p){
var vec__36495 = p__36494;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36495,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36495,(1),null);
var acc__$1 = vec__36495;
