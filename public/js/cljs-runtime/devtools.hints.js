...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26684__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26684__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26684__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e26683){var _e = e26683;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___26714 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___26714)){
var seen_errors_26715 = temp__5733__auto___26714;
if(cljs.core.truth_(seen_errors_26715.has(self))){
} else {
seen_errors_26715.add(self);

var temp__5735__auto___26716 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___26716)){
var sense_26717 = temp__5735__auto___26716;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26717)].join(''));
} else {
}
}
} else {
