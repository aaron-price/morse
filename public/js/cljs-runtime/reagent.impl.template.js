...
var G__27465 = o;
goog.object.set(G__27465,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__27487__delegate = function (args){
...
while (G__27488__i < G__27488__a.length) {G__27488__a[G__27488__i] = arguments[G__27488__i + 0]; ++G__27488__i;}
  args = new cljs.core.IndexedSeq(G__27488__a,0,null);
} 
return G__27487__delegate.call(this,args);};
G__27487.cljs$lang$maxFixedArity = 0;
G__27487.cljs$lang$applyTo = (function (arglist__27489){
var args = cljs.core.seq(arglist__27489);
return G__27487__delegate(args);
});
...
var G__27470 = o;
goog.object.set(G__27470,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__27491__i < G__27491__a.length) {G__27491__a[G__27491__i] = arguments[G__27491__i + 0]; ++G__27491__i;}
  args = new cljs.core.IndexedSeq(G__27491__a,0,null);
} 
...
var args = cljs.core.seq(arglist__27494);
...
var G__27471 = props;
var G__27471__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27471,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__27471);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27471__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__27472 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27472,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__27472;
}
})(),id_class);
...
var G__27473 = (cljs.core.count(argv) - first_child);
switch (G__27473) {
case (0):
...
var vec__27474 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27474,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27474,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27474,(2),null);
...
var temp__5739__auto___27515 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___27515 == null)){
} else {
var key_27516 = temp__5739__auto___27515;
(jsprops.key = key_27516);
}
...
var temp__5739__auto___27517 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___27517 == null)){
} else {
var key_27518 = temp__5739__auto___27517;
(jsprops.key = key_27518);
}
...
var temp__5739__auto___27527 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___27527 == null)){
} else {
var key_27528 = temp__5739__auto___27527;
(jsprops.key = key_27528);
}
...
var temp__5739__auto___27530 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___27530 == null)){
} else {
var key_27531 = temp__5739__auto___27530;
(jsprops.key = key_27531);
}
...
var temp__5739__auto___27532 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___27532 == null)){
} else {
var key_27533 = temp__5739__auto___27532;
(jsprops.key = key_27533);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27477_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__27477_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__27478 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27478,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27478,(1),null);
...
break;
default:
var G__27545 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__27546 = compiler;
v = G__27545;
compiler = G__27546;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template27484 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template27484 = (function (opts,id,fn_to_element,meta27485){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template27484.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27486,meta27485__$1){
var self__ = this;
var _27486__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template27484(self__.opts,self__.id,self__.fn_to_element,meta27485__$1));
}));

(reagent.impl.template.t_reagent$impl$template27484.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27486){
var self__ = this;
var _27486__$1 = this;
return self__.meta27485;
}));

(reagent.impl.template.t_reagent$impl$template27484.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template27484.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template27484.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template27484.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template27484.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta27485","meta27485",-317065790,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template27484.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template27484.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template27484");

(reagent.impl.template.t_reagent$impl$template27484.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template27484");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template27484.
 */
reagent.impl.template.__GT_t_reagent$impl$template27484 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template27484(opts__$1,id__$1,fn_to_element__$1,meta27485){
return (new reagent.impl.template.t_reagent$impl$template27484(opts__$1,id__$1,fn_to_element__$1,meta27485));
});

}

return (new reagent.impl.template.t_reagent$impl$template27484(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
