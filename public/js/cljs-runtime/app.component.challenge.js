...
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.Keyword(null,"note","note",1426297904).cljs$core$IFn$_invoke$arity$1(spec)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"count-log","count-log",1792434677)], null)))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.component.bar.morse_code_bar,chal_code,spec], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"hr","hr",1377740067)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.component.button.render_btn], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.component.bar.morse_code_bar,log_code,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(spec,new cljs.core.Keyword(null,"id","id",-1388402092),"log-bar")], null)], null);
});
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34913__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34913__$1,new cljs.core.Keyword(null,"index","index",-1531685915));
var challenge_specs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34913__$1,new cljs.core.Keyword(null,"challenge-specs","challenge-specs",1094085111));
var curr_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34913__$1,new cljs.core.Keyword(null,"curr-code","curr-code",905590378));
