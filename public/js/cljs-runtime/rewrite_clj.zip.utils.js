...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__31701,k,f){
var vec__31702 = p__31701;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31702,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31702,(1),null);
var loc = vec__31702;
...
var G__31734 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__31734;
continue;
}
break;
...
var G__31736 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__31736;
continue;
} else {
return zloc__$1;
...
var G__31737 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__31737;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__31710){
...
var path = map__31714__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31714__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__31711;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__31716){
var vec__31718 = p__31716;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31718,(0),null);
var map__31721 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31718,(1),null);
...
var path = map__31721__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31721__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__31718;
if(cljs.core.seq(r)){
...
var vec__31725 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31725,(0),null);
var map__31728 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31725,(1),null);
...
var path = map__31728__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31728__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31728__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31728__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31728__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
