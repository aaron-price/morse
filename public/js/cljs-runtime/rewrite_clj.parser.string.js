...
if((c === "\n")){
var G__31578 = escape_QMARK_;
var G__31579 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__31578;
lines = G__31579;
continue;
} else {
buf.append(c);

var G__31580 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__31581 = lines;
escape_QMARK_ = G__31580;
lines = G__31581;
continue;
...
var G__31566 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__31566) : rewrite_clj.node.string_node.call(null,G__31566));
});
...
var G__31575 = cljs.core.re_pattern(regex);
var G__31576 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__31575,G__31576) : rewrite_clj.node.token_node.call(null,G__31575,G__31576));
});
