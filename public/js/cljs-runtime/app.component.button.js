...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.button-parent","div.button-parent",-1870329860),"Drag up and down",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.slider","input.slider",-271160402),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"range",new cljs.core.Keyword(null,"min","min",444991522),"0",new cljs.core.Keyword(null,"max","max",61366548),"1",new cljs.core.Keyword(null,"step","step",1288888124),"1",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__35170_SHARP_){
return app.component.button.handle_slide((p1__35170_SHARP_.target.value | (0)));
})], null)], null)], null);
});
...
var ocr_35171 = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"btn-type","btn-type",1955528955)], null)));
try{if(cljs.core.keyword_identical_QMARK_(ocr_35171,new cljs.core.Keyword(null,"slider","slider",-472668865))){
...
var e__31919__auto__ = e35173;
if((e__31919__auto__ === cljs.core.match.backtrack)){
try{if(cljs.core.keyword_identical_QMARK_(ocr_35171,new cljs.core.Keyword(null,"click","click",1912301393))){
...
}catch (e35174){if((e35174 instanceof Error)){
var e__31919__auto____$1 = e35174;
if((e__31919__auto____$1 === cljs.core.match.backtrack)){
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(ocr_35171)].join('')));
} else {
