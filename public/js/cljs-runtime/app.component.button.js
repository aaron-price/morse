...
var ocr_38728 = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"btn-type","btn-type",1955528955)], null)));
try{if(cljs.core.keyword_identical_QMARK_(ocr_38728,new cljs.core.Keyword(null,"slider","slider",-472668865))){
...
}catch (e38730){if((e38730 instanceof Error)){
var e__31919__auto__ = e38730;
if((e__31919__auto__ === cljs.core.match.backtrack)){
try{if(cljs.core.keyword_identical_QMARK_(ocr_38728,new cljs.core.Keyword(null,"click","click",1912301393))){
...
var e__31919__auto____$1 = e38731;
if((e__31919__auto____$1 === cljs.core.match.backtrack)){
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(ocr_38728)].join('')));
} else {
