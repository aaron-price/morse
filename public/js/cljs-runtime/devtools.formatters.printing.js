...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq26792){
var G__26793 = cljs.core.first(seq26792);
var seq26792__$1 = cljs.core.next(seq26792);
var G__26794 = cljs.core.first(seq26792__$1);
var seq26792__$2 = cljs.core.next(seq26792__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26793,G__26794,seq26792__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__26819_SHARP_){
return (!((cljs.core.meta(p1__26819_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26822__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e26827){var _e__25911__auto__ = e26827;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e26829){var _e__25911__auto__ = e26829;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__26836 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__26837 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__26837);

try{var map__26838 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26838__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__26836);
}});
...
var temp__5733__auto___26865 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___26865)){
var managed_print_level_26866 = temp__5733__auto___26865;
var _STAR_print_level_STAR__orig_val__26843_26867 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__26844_26868 = managed_print_level_26866;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__26844_26868);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__26842_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__26842_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__26843_26867);
}} else {
job_fn();
}
