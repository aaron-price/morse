...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27262 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27262(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27270 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27270(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27277 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27277(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27287 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27287(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27293 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27293(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27305 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27305(reader);
}
});
...
var G__27426 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27427 = s.append(c);
c = G__27426;
s = G__27427;
continue;
}
