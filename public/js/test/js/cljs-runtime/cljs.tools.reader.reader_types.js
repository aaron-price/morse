...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27423 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27423(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27427 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27427(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27429 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27429(reader,ch);
}
});
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27433(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27439 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27439(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27443 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27443(reader);
}
});
...
var G__27493 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27494 = s.append(c);
c = G__27493;
s = G__27494;
continue;
}
